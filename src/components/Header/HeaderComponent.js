...
function HeaderComponent (props) {
  return (
    <header className="header d-flex align-items-center px-3"><h2>Victor's Meme Generator</h2>
        <button type="button" className="btn btn-light ml-auto" data-toggle="modal" data-target="#login">
          Login
        </button>
          ...
          <div className="modal-dialog d-flex justify-content-center" role="document">
            <div className="modal-content col-10">
              ...
              <div className="modal-body d-flex flex-column mx-4">
                <input type="email" id="loginEmail" className="form-control my-3" placeholder="Email" />
                <input
                  type="password"
                  id="loginPassword"
