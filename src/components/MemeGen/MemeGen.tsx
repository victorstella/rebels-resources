...
export function MemeGen({
  ...
  return (
    <div className="w-[95%] md:w-[80%] lg:w-[60%] mx-auto my-5 px-4 pb-4 pt-6 flex flex-col border-[3px] border-sky-400 hover:border-indigo-600 text-[#ffe81f] bg-black/75 transition-colors duration-200">
